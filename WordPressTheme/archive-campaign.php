...
<body>
  ...
  <main>
    <section class="mv-sub campaign-mv">
      ...
      <picture>
        <source media="(min-width:768px)" srcset="./assets/images/common/campaign-mv_pc.jpg">
    ...
    <section class="campaign-sub campaign-sub-content icon-fish">
      <div class="inner">
        ...
        <div class="campaign-sub__cards">
          ...
          <div class="campaign-card js-tab-2">
            ...
            <div class="campaign-card__content campaign-card__content--sub">
              ...
              <h2 class="campaign-card__title campaign-card__title--sub">ライセンス取得</h2>
              ...
              <p class="campaign-card__description u-desktop">ここにテキストが入ります。ここにテキストが入ります。ここにテキストが入ります。ここにテキストが入ります。
                <br>ここにテキストが入ります。ここにテキストが入ります。ここにテキストが入ります。ここにテキストが入ります。ここにテキストが入ります。ここにテキストが入ります。ここにテキストが入ります。ここにテキストが入ります。ここにテキスト
              </p>
              <p class="campaign-card__description-date u-desktop">2023/6/1-9/30</p>
          ...
          <div class="campaign-card js-tab-3">
            <div class="campaign-card__image">
            ...
            <div class="campaign-card__content campaign-card__content--sub">
              ...
              <h2 class="campaign-card__title campaign-card__title--sub">貸切体験ダイビング</h2>
              <p class="campaign-card__text campaign-card__text--sub">全部コミコミ(お一人様)</p>
              <p class="campaign-card__price campaign-card__price--sub">
          ...
          <div class="campaign-card js-tab-3">
            ...
            <div class="campaign-card__content campaign-card__content--sub">
              <p class="campaign-card__category">体験ダイビング</p>
              <h2 class="campaign-card__title campaign-card__title--sub">ナイトダイビング</h2>
              <p class="campaign-card__text campaign-card__text--sub">全部コミコミ(お一人様)</p>
              <p class="campaign-card__price campaign-card__price--sub">
          ...
          <div class="campaign-card js-tab-4">
            <div class="campaign-card__image">
            ...
            <div class="campaign-card__content campaign-card__content--sub">
              ...
              <h2 class="campaign-card__title campaign-card__title--sub">貸切ファンダイビング</h2>
              <p class="campaign-card__text campaign-card__text--sub">全部コミコミ(お一人様)</p>
              <p class="campaign-card__price campaign-card__price--sub">
        ...
        <!-- Wp-PageNavi -->
        <div class="campaign-sub__pagenav wp-pagenavi">
