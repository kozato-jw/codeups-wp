          ...
          <div class="blog-sub__cards blog-cards blog-cards--sub">
            <article class="blog-cards__item blog-card">
              <a href="single.html" class="blog-card__link">
                ...
                <div class="blog-card__meta">
                  ...
                  <h2 class="blog-card__title blog-card__title--sub">ライセンス取得</h2>
                </div>
            ...
            <article class="blog-cards__item blog-card">
              <a href="single.html" class="blog-card__link">
                ...
                <div class="blog-card__meta">
                  <time class="blog-card__date" datetime="2023-11-17">2023.11/17</time>
                  <h2 class="blog-card__title blog-card__title--sub">ウミガメと泳ぐ</h2>
                </div>
                <p class="blog-card__text">ここにテキストが入ります。ここにテキストが入ります。ここにテキストが入ります。ここにテキストが入ります。
            ...
            <article class="blog-cards__item blog-card">
              <a href="single.html" class="blog-card__link">
                ...
                <div class="blog-card__meta">
                  <time class="blog-card__date" datetime="2023-11-17">2023.11/17</time>
                  <h2 class="blog-card__title blog-card__title--sub">カクレクマノミ</h2>
                </div>
                <p class="blog-card__text">ここにテキストが入ります。ここにテキストが入ります。ここにテキストが入ります。ここにテキストが入ります。
                  <br>ここにテキストが入ります。ここにテキストが入ります。ここにテキスト
                </p>
            ...
            <article class="blog-cards__item blog-card">
              <a href="single.html" class="blog-card__link">
                <div class="blog-card__image">
                  <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/blog_5.jpg" alt="白いウミウシの画像">
                </div>
                <div class="blog-card__meta">
                  <time class="blog-card__date" datetime="2023-11-17">2023.11/17</time>
                  <h2 class="blog-card__title blog-card__title--sub">ウミガメと泳ぐ</h2>
            ...
            <article class="blog-cards__item blog-card">
              <a href="single.html" class="blog-card__link">
                <div class="blog-card__image">
                  <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/campaign_3.jpg" alt="暗い水中を泳ぐクラゲの画像">
                </div>
                <div class="blog-card__meta">
                  <time class="blog-card__date" datetime="2023-11-17">2023.11/17</time>
                  <h2 class="blog-card__title blog-card__title--sub">カクレクマノミ</h2>
            ...
            <!-- ピクパ確認用カード4枚（PCのみ表示のクラス付） -->
            <article class="blog-cards__item blog-card u-desktop">
              <a href="single.html" class="blog-card__link">
                <div class="blog-card__image">
                  <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/blog_3.jpg" alt="イソギンチャクに隠れている魚の画像">
                </div>
